...
struct _isr_table_entry __sw_isr_table _sw_isr_table[40] = {
	{(const void *)0x25d7f, (ISR)0x25d9d}, /* 0 */
	...
	{(const void *)0x1fded, (ISR)0x25d9d}, /* 6 */
