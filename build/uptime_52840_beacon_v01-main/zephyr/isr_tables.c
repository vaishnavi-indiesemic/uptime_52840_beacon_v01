...
struct _isr_table_entry __sw_isr_table _sw_isr_table[40] = {
	{(const void *)0x25dff, (ISR)0x25e1d}, /* 0 */
	...
	{(const void *)0x1fe6d, (ISR)0x25e1d}, /* 6 */
